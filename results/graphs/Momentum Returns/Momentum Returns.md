...
```python
period_returns_sh = pickle.load(open('temp_momentum/period_returns_sh.pkl', 'rb'))
...
pickle.dump(plot_data, open('temp_momentum/plot_data.pkl', 'wb'))

plot_data.to_csv('results/momentum_shanghai_plot_data.csv')
...
```
    ...
    <matplotlib.axes._subplots.AxesSubplot at 0x1134d61d0>
...
```python
plot_data.to_csv('momentum_shanghai.csv')
```
...
summary.to_csv('results/momentum_shanghai_summary.csv')
```
